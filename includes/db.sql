...
CREATE DEFINER=`root`@`localhost` TRIGGER `usuarios_after_update` AFTER UPDATE ON `usuarios` FOR EACH ROW BEGIN
			...
			insert into auditoria_usuarios (id_usuario,nombre_aud,email_aud,password_aud,celular_aud,whatsapp_aud,direccion_aud,ciudad_aud,usuario,img,proceso)
			values (NEW.id,NEW.nombre,NEW.email,NEW.password,NEW.celular,NEW.whatsapp,NEW.direccion,NEW.img,NEW.ciudad,user(),'UPDATE');
END;
...
-- Volcando datos para la tabla prub_trgger.usuarios: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id`, `nombre`, `email`, `password`, `celular`, `whatsapp`, `direccion`, `ciudad`, `img`) VALUES
	(12, 'santy', 'santyp638@gmail.com', '123', '3102942891', '3102942891', 'putumayo', 'villagarzon', _binary 0x696D6167656E2F75732E706E67),
  	(13, 'Franklin', 'lZzlxlzZl7@gmail.com', '123', '3102942891', '3102942891', 'putumayo', 'villagarzon', _binary 0x696D6167656E2F6F6E655F70696563655F6163652E6A7067);
	
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
-- Volcando datos para la tabla prub_trgger.producto: ~11 rows (aproximadamente)
/*!40000 ALTER TABLE `producto` DISABLE KEYS */;
INSERT INTO `producto` (`id`, `nombre`, `id_categoria_producto`, `valor`, `unidades`, `especificacion`, `imagen`, `id_usuarios`, `estado`) VALUES
	...
	(12, 'Micro porcesador', 2, 3000000, 1, 'Procesador de 10 generacion', _binary 0x696D6167656E2F3435393036372E6A7067, 13, 'activo'),
	(13, 'BMT', 1, 20000000, 2, 'Carro deportivo', _binary 0x696D6167656E2F342E6A7067, 13, 'activo');
